...
namespace app_gui_condicional02
{
    public partial class Form1 : Form
    {
        ...
        private void btn_calcular_Click(object sender, EventArgs e)
        {
            ...
            // Determinar si el promedio es mayor o igual a 70
        ...
        {
            // Obtener la nota de la prueba completiva ingresada por el usuario
            double notaCompletiva = Convert.ToDouble(txt_nota_completiva.Text);

            // Calcular la nota completiva (50% de la nota de la prueba completiva)
            double notaCompletivaCalculada = notaCompletiva * 0.5;

            // Calcular el promedio completivo (promedio original + nota completiva calculada)
            double promedioCompletivo = (Convert.ToDouble(txt_promedio.Text) + notaCompletivaCalculada) / 2;

            // Calcular el total completivo (suma del promedio original y la nota completiva calculada)
